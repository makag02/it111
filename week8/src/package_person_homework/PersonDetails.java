...
public class PersonDetails {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Used Car Discount: $" + firstPerson.carAdjustment(carRate));
        System.out.println("Total Monthly Insurance Rate: $" + (firstPerson.assumeGender(adjustedRate) +
                firstPerson.getRate(monthlyRate) + firstPerson.carAdjustment(carRate)));
        System.out.println();
        ...
        System.out.println("Used Car Discount: $" + secondPerson.carAdjustment(carRate));
        System.out.println("Total Monthly Insurance Rate: $" + (secondPerson.assumeGender(adjustedRate) +
                secondPerson.getRate(monthlyRate) + secondPerson.carAdjustment(carRate)));
    }
}
